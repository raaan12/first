    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="{{asset('images/02.jpg')}}">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class="active"><a href="index.html"><i class="fas fa-tshirt"></i><span class="menu-title" data-i18n="">Products</span></a>
          </li>
          <li class=" nav-item"><a href="icons.html"><i class="fas fa-cog"></i><span class="menu-title" data-i18n="">Categories</span></a>
          </li>
          <li class=" nav-item"><a href="cards.html"><i class="fas fa-shopping-cart"></i><span class="menu-title" data-i18n="">Commandes</span></a>
          </li>
          <li class=" nav-item"><a href="buttons.html"><i class="fas fa-envelope"></i><span class="menu-title" data-i18n="">Messages</span></a>
          </li>
          <li class="nav-item"><a href="employees.html"><i class="fas fa-users"></i><span class="menu-title" data-i18n="">Employees</span></a></li>
          </li>
          <li class=" nav-item"><a href="tables.html"><i class="fas fa-palette"></i><span class="menu-title" data-i18n="">Colors</span></a>
          </li>
          <li class=" nav-item"><a href="tables.html"><i class="fas fa-ruler"></i><span class="menu-title" data-i18n="">Sizes</span></a>
          </li>
          </li>
        </ul>
